...
header, address, channels, data, MVolt, IntVolt, names = "Dev", "/ai", list(), [0]*100000, list(), list(), list()



# Set the start, s, of enumerated loop below equal to 0.
s = 0
...
for j in range(1,6):
    ...
    ni.stream_readers.AnalogMultiChannelReader.read_many_sample(
    data=array,
